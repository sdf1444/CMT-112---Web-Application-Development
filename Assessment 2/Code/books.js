...
$(document).ready(function(){
	...
	$("#search").keyup(function(){
        ...
        $.each($("#tblBooks tbody tr"), function() {
	...
	$(document).ready(function () {
	    ...
	    $("#add").click(function () {
	    	...
	    	user.isbn = $("#isbn").val();
	    	user.author = $("#author").val();
	    	dynamicURL = "http://127.0.0.1:3000/books"
	    	methodName = "POST";
    ...
    $('table').on('click', 'button[id="edit"]', function(e){
        ...
        var isbn = $(this).closest('tr').children('td:nth-child(3)').text();
        var author = $(this).closest('tr').children('td:nth-child(4)').text();
